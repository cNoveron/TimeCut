 ...
 * 
 * $Id: AdminReasonDialog.java,v 1.1 2007/12/07 21:28:53 dyadix Exp $
 */
package net.sf.timecut.ui.swt;

import net.sf.timecut.ResourceHelper;
import net.sf.timecut.model.WaitReason;
...
public class AdminReasonDialog extends SWTDialog {
    
    private Text reasonText;
    private SWTAdminProjectTreePopup popup;
    
    public AdminReasonDialog(SWTAdminProjectTreePopup popup) {        
