...
import net.sf.timecut.ui.swt.search.FindDialog;
...
import net.sf.timecut.ui.swt.prefs.PreferencesDialog;
...
public class SWTAdminMainMenu {
    ...
    private void createEditMenu(int order) {
        ...
        _addMenuItem.setImage(_Window.getIconSet().getIcon("add", true));
        _Window.getMenuFactory().createAddMenu(_addMenuItem);
        //
        // Delete
        //
        ...
        this._Window.getMenuFactory().createPropertyItem(editMenu);
    }
    ...
    private void createHelpMenu(int order) {
        ...
        helpItem.setImage(_Window.getIconSet().getIcon("help", true));
        helpItem.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent evt) {
                //HelpWindow helpWindow = new HelpWindow(_Window);
                //helpWindow.open();
        ...
        webPageItem.setImage(_Window.getIconSet().getIcon("homepage", true));
        ...
        aboutItem.setImage(_Window.getIconSet().getIcon("about", true));
    ...
    private MenuItem createViewMenu(int order) {
        ...
        flaggedItem.setImage(_Window.getIconSet().getIcon("tasklist", true));
    ...
    private MenuItem createToolsMenu(int order) {
        ...
        optionsItem.setImage(_Window.getIconSet().getIcon("options", true));
    ...
    private MenuItem createSearchMenu(int order) {
        ...
        findItem.setImage(_Window.getIconSet().getIcon("find", true));
