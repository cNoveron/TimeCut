...
public class SWTProjectTreeView implements AppPreferencesListener,SWTTreeView {
	...
	public SWTProjectTreeView(SWTWindow Window) {
        ...
        _tree = new Tree(_Window.getProjectTreeContainer(), SWT.SINGLE
        ...
        this.disabledTextColor = new Color(_Window.getShell().getDisplay(),
            128, 128, 192);
        this.normalTextColor = new Color(_Window.getShell().getDisplay(),
            0, 0, 0);
        this.refFlagTextColor = new Color(_Window.getShell().getDisplay(), 255, 0, 0);
        this.greenFlagTextColor = new Color(_Window.getShell().getDisplay(), 0, 127, 0);
        this.blueFlagTextColor = new Color(_Window.getShell().getDisplay(), 0, 0, 255);
        this.orangeFlagTextColor = new Color(_Window.getShell().getDisplay(), 255, 127, 0);
        this.magentaFlagTextColor = new Color(_Window.getShell().getDisplay(), 200, 0, 100);
        Color treeColor = this.getTree().getBackground();
        dueHighlihgtColor = new Color(
                _Window.getShell().getDisplay(),
	...
	private void setFontStyle(TreeItem item, int style) {
        ...
        if (!this.fontMap.containsKey(fontKey)) {
            ...
            fn = new Font(_Window.getShell().getDisplay(), f);
